import "/error/node:node:crypto?from=argon2";
;
import "/error/node:node:util?from=argon2";
;
import require$$2 from "/-/@phc/format@v1.0.0-oYdciAq29Fr0NkpfAtF4/dist=es2019,mode=imports/optimized/@phc/format.js";
import gypBuild from "/-/node-gyp-build@v4.8.4-y5EkBqbhD8GFkGoHhcHl/dist=es2019,mode=imports/optimized/node-gyp-build.js";
var __dirname = "/tmp/cdn/_3YKHxqncp5BELyYgwAN2/node_modules/argon2";
...
const {randomBytes, timingSafeEqual} = require$$0;
const {promisify} = require$$1;
const {deserialize, serialize} = require$$2;
const {hash: bindingsHash} = gypBuild(__dirname);
const generateSalt = promisify(randomBytes);
const argon2d = 0;
const argon2i = 1;
const argon2id = 2;
var argon2d_1 = argon2d;
var argon2i_1 = argon2i;
var argon2id_1 = argon2id;
...
async function hash(password, options) {
  ...
  salt = salt != null ? salt : await generateSalt(16);
  const {
    hashLength,
...
var argon2 = {
  ...
  argon2id: argon2id_1,
  hash: hash_1,
  needsRehash: needsRehash_1,
  verify: verify_1
};
export default argon2;
export {argon2 as __moduleExports, argon2d_1 as argon2d, argon2i_1 as argon2i, argon2id_1 as argon2id, hash_1 as hash, needsRehash_1 as needsRehash, verify_1 as verify};
